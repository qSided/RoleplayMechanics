...
public class SkillEnabledEnchantingTableBlockEntityRenderer implements BlockEntityRenderer<SkillEnabledEnchantingTableBlockEntity> {
    public static final SpriteIdentifier BOOK_TEXTURE;
    private final BookModel book;
    
    public SkillEnabledEnchantingTableBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
        this.book = new BookModel(ctx.getLayerModelPart(EntityModelLayers.BOOK));
    }
    
    @Override
    public void render(SkillEnabledEnchantingTableBlockEntity enchantingTableBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
        matrixStack.push();

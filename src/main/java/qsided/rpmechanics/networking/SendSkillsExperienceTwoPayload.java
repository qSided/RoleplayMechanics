...
public record SendSkillsExperienceTwoPayload(Float farming,  Float smithing, Float crafting, Float axes, Float bows, Float cooking) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, SendSkillsExperienceTwoPayload> CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.FLOAT, SendSkillsExperienceTwoPayload::smithing,
            PacketCodecs.FLOAT, SendSkillsExperienceTwoPayload::crafting,
            PacketCodecs.FLOAT, SendSkillsExperienceTwoPayload::axes,
            PacketCodecs.FLOAT, SendSkillsExperienceTwoPayload::bows,
            PacketCodecs.FLOAT, SendSkillsExperienceTwoPayload::cooking,
